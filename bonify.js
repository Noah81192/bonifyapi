...
module.exports = class VOID {
  ...
  serverCount(message) {
  fetch(`https://www.bonify.cf/api/bots/stats`, {
        method: 'POST',
        headers: { 
  ...
  async search(id) {
  return await fetch(`https://www.bonify.cf/api/bots/${id}`, {
        method: 'GET'
    })
  ...
  async hasVoted(id) {
  return await fetch(`https://www.bonify.cf/api/bots/check/${id}`, {method: 'GET',headers: { 
